...
The sections below record the original launch baseline. See [Launch readiness](launch-readiness.md) for the current preparation pass and [Final pre-production verification](final-preproduction-verification.md) for the preceding staging release and [Phase 2 corrections](phase-2-corrections.md) for the previous correction pass, and [Phase 2 verification](phase-2-verification.md) for the preceding release and production launch gate.
